  ...
  appto.component('sames_all', {
    template: `<div id="forms">
          <div id="inputG">
            <!-- NexTone の作品コード -->
            <p>作品コード</p>
            <a class="links" href="https://search.nex-tone.co.jp/" target="_blank" rel="noopener noreferrer">作品コードはこちら</a><br>
        ...
        if(this.jasrac_code.match("\n")&&this.input_list[0].match("\n")&&this.input_list[1].match("\n")){
          ...
          music_info[0].length==music_info[1].length){
            ...
            for(i=0;i<jasrac_code.length;i++){
              ...
              link.innerHTML="<a class='links gform' href='https://docs.google.com/forms/d/e/1FAIpQLSdKdWaigAEYx-VW1r4cKdDHreAYjz0ObiIpv0Z4fY4kspwG0g/viewform?usp=pp_url&entry.54165318="+jasrac_code[i]+"&entry.86599061="+title[i]+"&entry.544664816="+artist[i]+"&entry.147907209="+artist[i]+"&entry.882127877="+artist[i]+"' target='_blank' rel='noopener noreferrer'>"+title[i]+"</a>";
          ...
          link.innerHTML="<a class='links gform' href='https://docs.google.com/forms/d/e/1FAIpQLSdKdWaigAEYx-VW1r4cKdDHreAYjz0ObiIpv0Z4fY4kspwG0g/viewform?usp=pp_url&entry.54165318="+this.jasrac_code+"&entry.86599061="+music_info[0]+"&entry.544664816="+music_info[1]+"&entry.147907209="+music_info[1]+"&entry.882127877="+music_info[1]+"' target='_blank' rel='noopener noreferrer'>"+music_info[0]+"</a>";
          request.appendChild(link);
          click_link();
          this.jasrac_code='';
          this.input_list=[];
      ...
      make_URL(){
        if(this.jasrac_code.match("\n")&&this.input_list[0].match("\n")&&this.input_list[1].match("\n")&&this.input_list[2].match("\n")){
          ...
          music_info[1].length==music_info[2].length){
            ...
            for(i=0;i<jasrac_code.length;i++){
              link = document.createElement('li');
              link.innerHTML="<a class='links gform' href='https://docs.google.com/forms/d/e/1FAIpQLSdKdWaigAEYx-VW1r4cKdDHreAYjz0ObiIpv0Z4fY4kspwG0g/viewform?usp=pp_url&entry.54165318="+jasrac_code[i]+"&entry.86599061="+title[i]+"&entry.544664816="+author[i]+"&entry.147907209="+author[i]+"&entry.882127877="+artist[i]+"' target='_blank' rel='noopener noreferrer'>"+title[i]+"</a>";
              request.appendChild(link);
              click_link();
            }; 
            this.jasrac_code='';
          ...
          link.innerHTML= "<a class='links gform' href='https://docs.google.com/forms/d/e/1FAIpQLSdKdWaigAEYx-VW1r4cKdDHreAYjz0ObiIpv0Z4fY4kspwG0g/viewform?usp=pp_url&entry.54165318="+this.jasrac_code+"&entry.86599061="+music_info[0]+"&entry.544664816="+music_info[2]+"&entry.147907209="+music_info[2]+"&entry.882127877="+music_info[1]+"' target='_blank' rel='noopener noreferrer'>"+music_info[0]+"</a>";
          request.appendChild(link);
          click_link();
          this.jasrac_code='';
          this.input_list=[];
        ...
        if(this.jasrac_code.match("\n")&&this.input_list[0].match("\n")&&this.input_list[1].match("\n")&&this.input_list[2].match("\n")&&this.input_list[3].match("\n")){
          ...
          music_info[2].length==music_info[3].length){
            ...
            for(i=0;i<jasrac_code.length;i++){
              ...
              link = document.createElement('li');
              link.innerHTML="<a class='links gform' href='https://docs.google.com/forms/d/e/1FAIpQLSdKdWaigAEYx-VW1r4cKdDHreAYjz0ObiIpv0Z4fY4kspwG0g/viewform?usp=pp_url&entry.54165318="+jasrac_code[i]+"&entry.86599061="+title[i]+"&entry.544664816="+lyric[i]+"&entry.147907209"+composer[i]+"&entry.882127877="+artist[i]+"' target='_blank' rel='noopener noreferrer'>"+title[i]+"</a>";
              request.appendChild(link);
              click_link();
            }; 
            this.jasrac_code='';
          ...
          link.innerHTML= "<a class='links gform' href='https://docs.google.com/forms/d/e/1FAIpQLSdKdWaigAEYx-VW1r4cKdDHreAYjz0ObiIpv0Z4fY4kspwG0g/viewform?usp=pp_url&entry.54165318="+this.jasrac_code+"&entry.86599061="+music_info[0]+"&entry.544664816="+music_info[2]+"&entry.147907209="+music_info[3]+"&entry.882127877="+music_info[1]+"' target='_blank' rel='noopener noreferrer'>"+music_info[0]+"</a>";
          request.appendChild(link);
          click_link();
          this.jasrac_code='';
          this.input_list=[];
